...
TEST(z80_macros, flags){
    /*Carry*/
    TEST_ASSERT_EQUAL(1, Z80_SETFLAG_CARRY(1, 0));
    TEST_ASSERT_EQUAL(1, Z80_SETFLAG_CARRY(255, 0));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_CARRY(0x7F, 0x80));

    /*Borrow*/
    TEST_ASSERT_EQUAL(1, Z80_SETFLAG_BORROW(128, 255));
    TEST_ASSERT_EQUAL(1, Z80_SETFLAG_BORROW(127, 128));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_BORROW(127, 127));
    ...
    /*Parity/Overflow*/
    TEST_ASSERT_EQUAL(Z80_FLAG_PARITY, Z80_SETFLAG_PARITY(0));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_PARITY(1));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_PARITY(2));
    TEST_ASSERT_EQUAL(Z80_FLAG_PARITY, Z80_SETFLAG_PARITY(3));

    /*Half-carry*/
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY(0x00, 0x00));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY(0xF0, 0x00));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY(0xF0, 0xF0));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_CARRY(0x0F, 0x01));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_CARRY(0x01, 0x0F));

    /*Half-borrow*/
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW(0x00, 0x00));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW(0xFF, 0x00));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW(0x0F, 0x0F));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW(0x10, 0x20));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_BORROW(0x00, 0x0F));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_BORROW(0x00, 0x09));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_BORROW(0x08, 0x09));

    /*Half-carry (16bit)*/
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY_16(0x0000, 0x0000));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY_16(0xF000, 0x0000));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_CARRY_16(0xF000, 0xF000));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_CARRY_16(0x0F00, 0x0100));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_CARRY_16(0x0100, 0x0F00));

    /*Half-borrow (16bit)*/
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW_16(0x0000, 0x0000));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW_16(0xFF00, 0x0000));
    TEST_ASSERT_EQUAL(0, Z80_SETFLAG_HALF_BORROW_16(0x0F00, 0x0F00));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_BORROW_16(0x1000, 0x2000));
    TEST_ASSERT_EQUAL(Z80_FLAG_HC, Z80_SETFLAG_HALF_BORROW_16(0x0E00, 0xF000));
