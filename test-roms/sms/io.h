...
#define IO_ENABLE_EXPANSION  (IO_EXPANSION ^ 0xFF)
#define IO_ENABLE_CARTRIDGE  (IO_CARTRIDGE ^ 0xFF)
#define IO_ENABLE_CARD       (IO_CARD ^ 0xFF)
#define IO_ENABLE_RAM        (IO_RAM ^ 0xFF)
#define IO_ENABLE_BIOS       (IO_BIOS ^ 0xFF)
#define IO_ENABLE_PERIPHERAL (IO_PERIPHERAL ^ 0xFF)
#define IO_ENABLE_UNK1       (IO_UNK1 ^ 0xFF)
#define IO_ENABLE_UNK0       (IO_UNK0 ^ 0xFF)
